...
C K1=1 stands for PHASE 10 (granulite) and K1=2 stands for PHASE11 (eclogite), C_e1 for granulite and C_e2 for eclogite
      !print*,TIME
      !print*,"timedtime",TEMP,DTEMP
      !!if (TIME.GT.5) then
      !!    print*,"stress",STRESS
      !!end if
      !print*,"statev2",STATEV(2)
      DO K1=1,2
...
C calculation for plasticity 
      DO K1=1,2
          ...
          !print*,"overstress",Over_s
           !print*,"von",S_vm_t
           !!print*,"Q",Q
           !!print*,"sdv3",STATEV(3)
           !print*,"sdev_t",Sdev_t
           !print*,"stress1",STRES1
           !print*,"STR",STR
           !print*,"sigmap",sigm_p
           !print*,"almdg",STATEV(K1)
          !if (Over_s.GT.0) then
          !    print*,"overstress",Over_s
          !    print*,"STRES1",STRES1
          !    print*,"von",S_vm_t
...
C Check yielding
     ...
     1        DTIME,EG(K1),C_eff,D_n,NTENS,NDI,PROPS(10),Q,PROPS(K1+12),Ce,resd1) !!calculate
              ...
              !print*,"resd1,rnorm,rnor0,toler",resd1,r_norm,r_nor0,TOLER
              iter8=0
     ...
     1        DTIME,EG(K1),C_eff,D_n,NTENS,NDI,PROPS(10),Q,PROPS(K1+12),Ce,resd1) !!calculate
              ...
              !S_dev=Sdev_t-TWO*EG(K1)*sqrt(3.0/2.0)*del_mu*D_n! correction to s_dev 11
